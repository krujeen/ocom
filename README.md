...
2. "Triangle Star" รับค่า n แล้วสร้างรูปสามเหลี่ยมด้วยดอกจัน (*) ที่มีความสูง n แถว
3. "Square Frame" รับค่า n แล้วสร้างกรอบสี่เหลี่ยมจัตุรัสขนาด n x n โดยใช้เครื่องหมาย #
4. "Alphabet Staircase" รับค่า n (1-26) แล้วสร้างบันไดตัวอักษรจาก A ถึงตัวอักษรที่ n
5. "Number Pyramid" รับค่า n แล้วสร้างพีระมิดตัวเลขที่มีความสูง n แถว โดยเริ่มจาก 1 ที่ยอด
6. "Reverse Star Triangle" รับค่า n แล้วสร้างสามเหลี่ยมกลับหัวด้วยดอกจัน (*) ที่มีความสูง n แถว
7. "Checkered Pattern" รับค่า n แล้วสร้างลายตารางหมากรุกขนาด n x n โดยใช้ X และ O
8. "Diamond Outline" รับค่า n แล้วสร้างเส้นขอบรูปเพชรที่มีความสูง 2n-1 แถว โดยใช้ *
9. "Hourglass Pattern" รับค่า n แล้วสร้างรูปนาฬิกาทรายที่มีความสูง 2n-1 แถว โดยใช้ *
10. "Multiplication Table" รับค่า n แล้วสร้างตารางสูตรคูณขนาด n x n
11. "Arrow Pattern" รับค่า n แล้วสร้างรูปลูกศรที่ชี้ไปทางขวา โดยมีความยาว n แถว ใช้ - และ >
12. "Plus Sign" รับค่า n แล้วสร้างรูปเครื่องหมายบวก (+) ขนาด 2n-1 x 2n-1 โดยใช้ *
13. "Hollow Rectangle"รับค่า w และ h แล้วสร้างสี่เหลี่ยมผืนผ้าที่มีขอบเป็น # และภายในว่างเปล่า
14. "Alternating Chars"รับค่า n แล้วสร้างแพทเทิร์นสลับระหว่าง * และ # เป็นรูปสามเหลี่ยม n แถว
15. "Number Box"รับค่า n แล้วสร้างกล่องตัวเลขขนาด n x n โดยเริ่มจาก 1 ที่มุมบนซ้ายและเพิ่มขึ้นตามเข็มนาฬิกา
16. "Rhombus Outline"รับค่า n แล้วสร้างรูปข้าวหลามตัดที่มีเฉพาะเส้นขอบ โดยใช้ * และมีความสูง 2n-1 แถว
17. "Letter Pyramid"รับค่า n (1-26) แล้วสร้างพีระมิดตัวอักษรที่มีความสูง n แถว โดยเริ่มจาก A ที่ยอด
18. "X Pattern"รับค่า n แล้วสร้างรูปตัว X ขนาด n x n โดยใช้ *
19. "Heart Shape"รับค่า n แล้วสร้างรูปหัวใจอย่างง่ายขนาด n แถว โดยใช้ *
20. "Zigzag Pattern"รับค่า n และ m แล้วสร้างแพทเทิร์นซิกแซกความกว้าง n และความสูง m โดยใช้ *
21. "Diagonal Line" รับค่า n แล้วสร้างเส้นทแยงจากมุมบนซ้ายไปมุมล่างขวาในกรอบขนาด n x n โดยใช้ *
22. "Staircase Pattern"รับค่า n แล้วสร้างรูปบันไดที่มี n ขั้น โดยใช้ # และ -
23. "Mirrored Triangle"รับค่า n แล้วสร้างรูปสามเหลี่ยมที่สมมาตรกัน มีความสูง n แถว โดยใช้ *
24. "Hollow Diamond"รับค่า n แล้วสร้างรูปเพชรที่มีเฉพาะเส้นขอบ โดยใช้ * และมีความสูง 2n-1 แถว
25. "Number Snake"รับค่า n แล้วสร้างรูปงูตัวเลขขนาด n x n โดยเริ่มจาก 1 และเพิ่มขึ้นเรื่อยๆ ในรูปแบบซิกแซก
26. "Character Frame"รับค่า n และตัวอักษร c แล้วสร้างกรอบขนาด n x n โดยใช้ตัวอักษร c
27. "Pyramid of Numbers"รับค่า n แล้วสร้างพีระมิดตัวเลขที่มีความสูง n แถว โดยแต่ละแถวแสดงเลขซ้ำกันเท่ากับหมายเลขแถว
28. "Checkerboard"รับค่า n แล้วสร้างกระดานหมากรุกขนาด n x n โดยใช้ # และ -
29. "Arrow Pattern"รับค่า n แล้วสร้างรูปลูกศรที่ชี้ไปทางขวา โดยมีความยาว n แถว ใช้ - และ >
30. "Hollow Hourglass"รับค่า n แล้วสร้างรูปนาฬิกาทรายที่มีเฉพาะเส้นขอบ โดยใช้ * และมีความสูง 2n-1 แถว
31. "Alphabet Square"รับค่า n (1-26) แล้วสร้างตารางตัวอักษรขนาด n x n โดยเริ่มจาก A และวนกลับเมื่อถึง Z

**Medium Level**
1. "Diamond Fractal" รับค่า n แล้วสร้างรูปเพชรแบบ fractal โดยใช้ * และ - ขนาดของเพชรขึ้นอยู่กับ n และมีเพชรเล็กๆ ซ้อนอยู่ภายใน
2. "Spiral Square" รับค่า n แล้วสร้างรูปสี่เหลี่ยมที่มีเส้นเป็นรูปก้นหอยภายใน โดยใช้ตัวเลขเรียงลำดับจาก 1 ถึง n^2
3. "3D Pyramid" รับค่า n แล้วสร้างรูปพีระมิด 3 มิติ โดยใช้ *, /, \ และ - เพื่อแสดงด้านต่างๆ ของพีระมิด
4. "Hexagonal Honeycomb" รับค่า n แล้วสร้างรูปรังผึ้งหกเหลี่ยมขนาด n x n โดยใช้ * และ -
5. "Circular Ripple" รับค่า n แล้วสร้างรูปวงกลมที่มีคลื่นกระเพื่อมออกไปจากจุดศูนย์กลาง โดยใช้ ~, -, และ *
6. "Maze Generator" รับค่า n แล้วสร้างเขาวงกตขนาด n x n โดยใช้ # เป็นกำแพงและ . เป็นทางเดิน ต้องมีทางเข้าและทางออก
7. "Sierpinski Triangle" รับค่า n แล้วสร้างสามเหลี่ยม Sierpinski โดยใช้ * และช่องว่าง ความสูงของสามเหลี่ยมเท่ากับ 2^n - 1
8. "Clock Face" รับค่าชั่วโมงและนาที แล้วสร้างหน้าปัดนาฬิกาแบบอนาล็อกที่แสดงเวลาตามที่รับเข้ามา โดยใช้ *, |, -, และตัวเลข
9. "DNA Helix" รับค่า n แล้วสร้างรูป DNA helix ความยาว n โดยใช้ A, T, C, G, |, -, และ /
10. "Yin Yang Symbol" รับค่า n แล้วสร้างสัญลักษณ์หยินหยางขนาด n x n โดยใช้ * และ .
11. "Spiral Number Matrix" รับค่า n แล้วสร้างเมทริกซ์ขนาด n x n ที่มีตัวเลขเรียงกันเป็นรูปก้นหอยจากนอกเข้าใน
12. "Christmas Tree" รับค่า n แล้วสร้างต้นคริสต์มาสที่มีความสูง n ชั้น โดยใช้ * และ |
13. "Binary Clock" รับเวลาในรูปแบบ HH:MM:SS แล้วแสดงผลเป็นนาฬิกาเลขฐานสองโดยใช้ * และ .
14. "Alphabet Diamond" รับค่า n (1-26) แล้วสร้างรูปเพชรที่มีตัวอักษร A ถึง n ในรูปแบบสมมาตร
15. "Fibonacci Spiral" รับค่า n แล้วสร้างรูปก้นหอยที่มีขนาดตามลำดับ Fibonacci โดยใช้ตัวเลขแสดงลำดับ
16. "Tic-Tac-Toe Board Generator" รับสตริงที่แทนการเล่น Tic-Tac-Toe แล้วแสดงผลเป็นกระดานพร้อมตำแหน่ง X และ O
17. "Wave Pattern" รับค่า n และ m แล้วสร้างรูปแบบคลื่นที่มีความกว้าง n และความยาว m โดยใช้ ~, -, และ _
18. "Recursive Squares" รับค่า n แล้วสร้างรูปสี่เหลี่ยมซ้อนกันแบบ recursive โดยมีระดับความลึก n
19. "Barcode Generator" รับสตริงตัวเลข แล้วสร้างบาร์โค้งอย่างง่ายโดยใช้ | และ ช่องว่าง
20. "Tetris Shape Rotator" รับรูปร่างของชิ้นส่วน Tetris และองศาการหมุน แล้วแสดงผลลัพธ์หลังการหมุน
...
**Medium Level**
1. เขียนฟังก์ชันหาค่าเฉลี่ยของอาร์เรย์ โดยไม่ใช้ฟังก์ชันสำเร็จรูป
2. สร้างฟังก์ชันหาจำนวนที่ซ้ำกันในอาร์เรย์ และแสดงความถี่ของแต่ละจำนวน
3. เขียนโปรแกรมหมุนอาร์เรย์ไปทางขวา n ตำแหน่ง โดย n เป็นค่าที่รับจากผู้ใช้
4. สร้างฟังก์ชันรวมสองอาร์เรย์ที่เรียงลำดับแล้วให้เป็นอาร์เรย์เดียวที่ยังคงเรียงลำดับ
5. เขียนโปรแกรมหาผลรวมของทุกคู่ตัวเลขในอาร์เรย์ที่มีผลรวมเท่ากับค่าที่กำหนด
6. สร้างฟังก์ชันหาเลขที่หายไปในอาร์เรย์ที่มีเลข 1 ถึง n โดยมีเลขหายไป 1 ตัว
7. เขียนโปรแกรมแบ่งอาร์เรย์เป็นสองส่วนโดยให้ผลรวมของทั้งสองส่วนใกล้เคียงกันที่สุด
8. สร้างฟังก์ชันหาความยาวของ subarray ที่มีผลรวมมากที่สุด
9. เขียนโปรแกรมหา peak element ในอาร์เรย์ (ตัวเลขที่มีค่ามากกว่าตัวข้างๆ ทั้งสองด้าน)
10. สร้างฟังก์ชันหาตัวเลขที่ปรากฏเกินครึ่งหนึ่งของความยาวอาร์เรย์ (ถ้ามี)
